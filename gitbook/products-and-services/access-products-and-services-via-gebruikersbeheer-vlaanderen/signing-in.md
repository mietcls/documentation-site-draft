...
* **Firefox**\
  Visit this link [https://support.mozilla.org/en-US/kb/pop-blocker-settings-exceptions-troubleshooting#w\_pop-up-blocker-settings](https://support.mozilla.org/en-US/kb/pop-blocker-settings-exceptions-troubleshooting#w_pop-up-blocker-settings) and choose Pop-up blocker settings.
* **Chrome**\
